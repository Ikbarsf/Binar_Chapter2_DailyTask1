...
function getFemale(data) {
    // membuat variabel result berupa array kosong untuk menyimpan data yang sudah di filter
    let result = []
    // looping untuk semuda data 
    for(let i = 0; i < data.length; i++){
        // membuat filter untuk user bergender 'female'
